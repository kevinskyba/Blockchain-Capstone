...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != owner, "Owner must be different");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == owner || isApprovedForAll(owner, msg.sender), "Sender is neither owner nor approved");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(!_exists(tokenId), "Token does already exist");
        require(to != address(0), "Adress is invalid");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == ownerOf(tokenId), "Caller must be owner of the token");
...
contract MyCustomERC721Token is ERC721Metadata("MyCustomERC721Token", "MCET", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
